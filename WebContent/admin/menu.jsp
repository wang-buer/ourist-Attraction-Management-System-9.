	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>旅游景点管理</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/jingdian/jingdianAdd.jsp' target='main'>景点信息添加</a> </li>
	            <li><a href='<%=path %>/jingdianMana.action' target='main'>景点信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>旅游线路管理</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/xianlu/xianluAdd.jsp' target='main'>旅游线路添加</a> </li>
	            <li><a href='<%=path %>/xianluMana.action' target='main'>旅游线路管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
